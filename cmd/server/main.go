...
// envDuration parses a Go duration string ("10m", "45s"). An unparseable
// value falls back rather than failing startup: a typo in one tuning knob
// must not keep the viewer from booting.
